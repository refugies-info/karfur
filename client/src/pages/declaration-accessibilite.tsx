  ...
  return (
    <div className={styles.container + " animated fadeIn"}>
      ...
      <p>
        ...
        l’accessibilité de la plateforme Réfugiés.info.
      </p>
      <p>
      ...
      <p>
        À cette fin, elle met en œuvre la stratégie et les actions détaillées
        dans son plan pluriannuel en cours d'élaboration. Cette déclaration
        d’accessibilité s’applique au site web Réfugiés.info
      </p>

      <h2 className={styles.h4}>État de conformité : non conforme</h2>
      <p>
        Le site Réfugiés.info est non conforme avec le RGAA 4.1 de niveau
        Double-A (AA) en raison des non-conformités et des dérogations énumérées
        ci-dessous.
      </p>
      <h3 className={styles.h4}>Résultats des tests</h3>
      <p>
        L’audit de conformité réalisé par la société Ipedis révèle que le taux
        moyen de conformité est de 37.25% :
      </p>
      <ul>
      ...
      <div className={styles.box}>
        <p className={styles.box_title}>
          Résultat de conformité des critères au RGAA 4.1
        </p>
        <Image
      ...
      <ul>
        <li>
          Plusieurs éléments de non-conformité sont décrits dans ce document,
          dont certains récurrents sur plusieurs pages :
        </li>
        <li>
          Certaines alternatives d'images ne sont pas totalement explicites{" "}
        </li>
        <li>
          Les images décoratives ne sont pas ignorées par le lecteur d'écran
        </li>
        <li>
          Certaines alternatives d'images ne sont pas totalement explicites{" "}
        </li>
        ...
        <li>
          ...
          composants d’interface n'est pas suffisant
        </li>
        ...
        <li>
          Certaines listes d'éléments ne sont pas définies de manière accessible
        </li>
      ...
      <p>
        Contacter la direction de communication Réfugiés.info à l'adresse mail
        suivante :
      </p>
      <FButton
        type="dark"
