      ...
      <div className={"shadow-wrapper" + (editing ? " active" : "")}>
          ...
          <Row>
            <Col xl="4" lg="4" md="4" sm="4" xs="4" className="handleBetween">
              ...
              {process.env.REACT_APP_DATADOG_TOKEN
                ? process.env.REACT_APP_DATADOG_TOKEN.substring(0, 5)
                : "no key"}
            </Col>
          ...
          {editing && (
            <Row className="nb-car-row">
              <Col
                ...
                sm="4"
                xs="4"
                className="handleBetween"
              />
              <Col xl="8" lg="8" md="8" sm="8" xs="8" className="handleBetween">
                <span className="texte-vert">
                  {(user.description || "").length}
                </span>{" "}
                {t("UserProfile.nbCarMax", "sur 120 caractères")}
              </Col>
            </Row>
          )}
        </CardBody>
        {editing ? (
          <CardFooter className="mt-10">
            ...
            >
              {t(
                "UserProfile.Modifier le mot de passe",
