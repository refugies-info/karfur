          ...
          <FormGroup row>
            ...
            <Col xs="12" md="9">
              <Input 
                ...
                onChange = {props.handleChange} />
              <FormText color="muted">Description en bref (100 caractères environ)</FormText>
            </Col>
          </FormGroup>
          <FormGroup row>
            <Col md="3">
            ...
            <Col md="9">
              <FormGroup check inline className="radio">
                <Input 
                  ...
                  name="theme" 
                  value={true}
                  checked={props.theme.themeIsUnder === 'true' || props.theme.themeIsUnder===true}
                  onChange = {props.handleChange}  />
                <Label check className="form-check-label" htmlFor="themeIsUnder">Oui</Label>
              </FormGroup>
              <FormGroup check inline className="radio">
                <Input 
                  className="form-check-input" 
                  ...
                  name="theme" 
                  value={false}
                  checked={props.theme.themeIsUnder === 'false' || props.theme.themeIsUnder===false}
                  onChange = {props.handleChange}  />
                <Label check className="form-check-label" htmlFor="themeIsUnder">Non</Label>
              </FormGroup>
              <FormText color="muted">Le thème a-t-il des dépendances envers un autre thème ?</FormText>
            </Col>
          </FormGroup>
          {(props.theme.themeIsUnder === 'true' || props.theme.themeIsUnder===true) &&
            <FormGroup row>
              <Col md="3">
                <Label htmlFor="themeUnderId">Sélectionnez le thème de rattachement</Label>
              </Col>
              <Col xs="12" md="9">
                <Input 
                  type="select" 
