          ...
          <FormGroup row>
            ...
            <Col xs="12" md="9">
              ...
              <FormText color="muted">
                ...
                pour le tableau de correspondance.
              </FormText>
            </Col>
          </FormGroup>
          <FormGroup row>
            ...
            <Col md="9">
              <FormGroup check inline className="radio">
                <Input
                  ...
                  value={true}
                  checked={
                    props.langue.langueIsDialect === "true" ||
                    props.langue.langueIsDialect === true
                  }
                  onChange={props.handleChange}
                />
              ...
              <FormGroup check inline className="radio">
                <Input
                  ...
                  value={false}
                  checked={
                    props.langue.langueIsDialect === "false" ||
                    props.langue.langueIsDialect === false
                  }
                  onChange={props.handleChange}
                />
            ...
            <FormGroup row>
              <Col md="3">
                <Label htmlFor="select">
                  Sélectionnez la langue de rattachement
                </Label>
              </Col>
              <Col xs="12" md="9">
                <Input
