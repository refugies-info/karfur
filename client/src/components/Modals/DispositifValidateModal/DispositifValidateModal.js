  ...
  return(
    <Modal isOpen={props.show} toggle={props.toggle} className="dispositif-validate-modal">
      ...
      <ModalFooter>
        ...
        <FButton name="checkmark-circle-2-outline" fill={variables.noir} onClick={validateAndClose} className="btn-go" disabled={!props.abstract || props.abstract === "" || props.abstract.length > 110}>
          Envoyer
        </FButton>
      </ModalFooter>
    </Modal>
