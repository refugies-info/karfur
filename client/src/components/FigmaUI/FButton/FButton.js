...
class FButton extends Component {
  ...
  render() {
    //Possible types: default, dark, validate, outline (retour, en blanc), outline-black, pill (vocal), light-action (light-PDF), theme (ac couleur de theme dark), error (rouge), help (rouge clair), login and signup (blue)
