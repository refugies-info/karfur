exports.prod = {
    "body" : {
        "Homepage" : {
            "subtitle" : {
                "fr" : "Ici, je trouve et partage de l'information pour réussir mon projet de vie",
                ...
                "ru" : "Здесь я нахожу и делюсь информацией, чтобы преуспеть в моих планах на будущее"
            },
            "explication lexique" : {
                "fr" : "Consultez le lexique collaboratif pour comprendre les mots que vous rencontrez dans votre navigation.",
                ...
                "ru" : "Значение незнакомых слов вы можете посмотреть в разделе Словарь терминов."
            },
            ...
            "information vérifiée subheader" : {
                ...
                "ru" : "Вся предложенная информация проверяется и исправляется перед публикацией, чтобы подтвердить ее актуальность и избежать ошибок. Даже после публикации, вы можете легко сообщить о найденной ошибке."
            },
            "disponible langues" : {
            ...
            "disponible langues subheader" : {
                ...
                "ru" : "Помогите перевести, чтобы сделать информацию более доступной для беженцев."
            },
            ...
            "contributive subheader" : {
                "fr" : "Un peu comme Wikipédia, réfugiés.info est un outil simple pour réunir de l'information pratique. Participez à l'enrichissement du site en rédigeant vous-même de nouvelles fiches. Vous pouvez également suggérer des modifications sur les fiches existantes.",
                ...
                "ru" : "Задуманный по типу википедии, сайт réfugiés.info - это простой инструмент для сбора и структурирования полезной информации. Участвуйте в наполнении сайта, самостоятельно создавая новые страницы с информацией или корректируя уже существующие."
            },
            "Super recherche" : {
                "fr" : "Super recherche",
            ...
            "Covid alert" : {
                "fr" : "Réfugiés.info se mobilise pour répondre à vos questions sur le Covid-19 par le livetchat (icône bleue en bas à droite de l’écran).",
                "id" : "struct_sktwi19mhk853n1m6",
                "fa" : "Refugees.info برای پاسخ دادن به سؤالات شما درباره Covid-19 از طریق livetchat (نماد آبی در پایین سمت راست صفحه) بسیج شده است.",
                "ps" : "ریفیوجزاینفوRéfugiés.info د کوویډ - 19 وبا  په اړه د لایف چاټ livetchat له لارې ستاسو پوښتنو ته ځواب وایی (د سکرین په ښي اړخ کې نیلي عکس).",
                ...
                "ar" : "Réfugiés.info يجيب على أسئلتكم حول الكوفيدـ19 عبر التواصل المباشر/لايف تشات (الأيقونة الزّرقاء في أسفل يمين الشاشة).",
                "en" : "Refugies.info is all set to answer your questions about Covid-19 through a live chat (click on the blue icon on the bottom right hand of the screen).",
                "ru" : "Команда Réfugiés.info готова ответить на ваши вопросы о Covid-19 онлайн (синий значок в правом нижнем углу экрана)."
            },
            "Covid link" : {
        ...
        "Tables" : {
            ...
            "Réfugiés-info est une plateforme contributive, vous pouvez participer à son enrichissement" : {
                "fr" : "Réfugiés.info est une plateforme contributive, vous pouvez participer à son enrichissement",
                ...
                "ru" : "Réfugiés.info - это платформа, создаваемая совместно и вы можете участвовать в ее наполнении и улучшении"
            },
            ...
            "bilingue" : {
                "fr" : "Bilingue ? Polyglotte ? Participez à l’effort de traduction à votre rythme :",
                ...
                "ru" : "Вы владеете двумя или несколькими языками? Вы можете помочь с переводом сайта, работая в удобном вам темпе:"
            },
            ...
            "Proposez de nouveaux contenus pour enrichir la plateforme, ou aider à corriger et à tenir à jour les contenus existants" : {
                ...
                "en" : "Propose new content to enrich the platform, or help to edit and update existing content",
                "fa" : "برای بهبود و غنی سازی پلتفرم لطفا محتوی جدید را پیشنهاد دهید و یا به تصحیح و به روزرسانی مطالب موجود کومک و همکاري نماید.",
                "ps" : "د پلیټفرم د لا بهبود او بهتري په خاطرنوي وړاندیزونه اوپیشنهادونه ورکړي، او  یاهم د موجوده معلوماتو په بهتري او بهبود  کې مرسته وکړئ",
                "ti-ER" : "ነዚ መደብ ንምምዕባል ኣብዚ ገጽ ናይ ሓቤረታት  ኣብርክቶ ክትገብሩን፣  ወይ ዝኾነ ጌጋ ምስ ዝህሉ ኣብ ጽሑፍ ንምእራም  ክትሳተፉን ትኽእሉ ኢኹም ፤፣",
                "ar" : "اقترح محتوى جديد لإثراء الموقع، أو ساعد في تصحيح وتحديث المحتوى الحالي",
                "ru" : "Участвуйте в развитии платформы, добавляя новую информацию или обновляя и исправляя существующую"
            },
        ...
        "UserProfile" : {
            ...
            "Merci de donner de votre temps" : {
                ...
                "ps" : "ستاسو له وخت او همکاری نه مننه چی د کډوالو په ټولنه کې د ادغام کیدو لپاره مو ورکړی.",
            ...
            "Grâce à vous" : {
                "fr" : "Grâce à vous, les personnes réfugiées seront plus et mieux informées",
                ...
                "ps" : "ستاسو د همکاري او مرستي په نتیجه کې به مهاجرین لا نور هم بهتره او ښو معلوماتوته لاس رسي پیدا کړي.",
                "ru" : "Благодаря вам беженцы получат доступ к необходимой информации и будут лучше осведомлены"
            },
            "Merci de participer" : {
                "fr" : "Merci de participer à rendre accessible l’information au plus grand nombre",
                "id" : "struct_9u1txbk37dw5gg",
                "en" : "Thanks for your help making information accessible to as many people as possible!",
                ...
                "fa" : "مشارکت درایجاد اطلاعات و انها را دردسترسی هر چه بیشتر مردم قرار دادن از شما تشکری می کنیم",
                "ps" : "د لا زیاتو کسانو لپاره د معلوماتو په تهیه کولو او برخه اخستلو کې ستاسو نه مننه کوو.",
                "ru" : "Спасибо за то, что помогаете сделать информацию доступной для еще большего количества людей."
            }
        },
        "QuiSommesNous" : {
            "Qui sommes-nous" : {
            ...
            "subheader" : {
                "fr" : "Réfugiés.info améliore le parcours d’intégration des bénéficiaires de la protection internationale en France",
                ...
                "ru" : "Réfugiés.info облегчает процесс интеграции беженцев и просителей убежища во Франции"
            },
            "Missions" : {
                "fr" : "Missions",
            ...
            "Mission_1_subheader" : {
                "fr" : "Obtenir l’asile, c’est surtout reconstruire. Un chez soi, un réseau, une vocation. Le déracinement a souvent brouillé les repères, les ambitions, les objectifs. Réfugiés.info propose un outil structurant l’action et permettant aux réfugiés d’atteindre plus vite et plus sereinement leurs objectifs de vie",
            ...
            "Mission_3_header" : {
                ...
                "ru" : "Найти и объединить на одной платформе программы поддержки беженцев во Франции"
            },
            "Mission_3_subheader" : {
                "fr" : "De nombreux dispositifs émergent en France pour accueillir et accompagner les personnes réfugiées. Ces actions souffrent parfois d’un manque de visibilité et ne profitent pas au plus grand nombre. Réfugiés.info a pour mission de recenser, de rendre visible et de rendre accessible ces nombreuses initiatives",
            ...
            "problem_1_subheader" : {
                "fr" : "Mieux comprendre c'est déjà mieux accueillir. Migrant, demandeur d'asile ou réfugié ne désignent pas les mêmes réalités. Réfugiés.info s'adresse aux réfugiés statutaires, c'est-à-dire aux personnes à qui la France accorde une protection internationale car leur vie est menacée dans leur pays d'origine",
                ...
                "ru" : "Лучше понять - значит лучше помочь. Мигранты, просители убежища и беженцы - это разные термины. Сайт Réfugiés.info предназначен для лиц получивших официальный статус беженца во Франции на основании того, что их жизни находятся под угрозой в стране их происхождения."
            },
            "problem_2_header" : {
            ...
            "problem_2_subheader" : {
                "fr" : "L’évolution rapide de la législation, le foisonnement de l’offre associative et la complexité de certaines démarches administratives rendent difficile la compréhension des droits et devoirs. Réfugiés.info centralise une information fiable, à jour et vulgarisée",
                ...
                "ru" : "Постоянно меняющееся законодательство, рост числа ассоциаций и сложность административных процедур затрудняют понимание прав и обязанностей беженцев. Сайт Réfugiés.info позволяет собрать в одном месте, упорядочить и объяснить понятным языком актуальную и достоверную информацию."
            },
            "problem_3_header" : {
            ...
            "problem_3_subheader" : {
                "fr" : "Déménagement, changement de projet de vie... À chaque nouvel interlocuteur, il faut souvent tout reprendre à zéro. Réfugiés.info propose aux réfugiés de se créer un parcours dans un espace personnel qu'il peuvent partager avec leurs aidants",
            ...
            "contributive_1_subheader" : {
                "fr" : "Les valeurs d’ouverture et de transparence sont au coeur du projet Réfugiés.info : le code source du site est entièrement disponible. Un réseau ouvert participe à la conception et conseille l’équipe du projet sur les besoins et les fonctionnalités à développer",
                ...
                "ru" : "Ценности открытости и прозрачности лежат в основе проекта Réfugiés.info: исходный код сайта полностью доступен. Открытая группа экспертов участвует в разработке и консультирует проектную группу о потребностях и необходимости разработки нового функционала сайта."
            },
            "Voir le code source" : {
            ...
            "contributive_2_subheader" : {
                "fr" : "Seuls les acteurs locaux sont capables de recenser efficacement les actions et de nourrir une base de connaissance commune. Ainsi Réfugiés.info permet à chaque territoire de recenser et de valoriser ses initiatives tout en découvrant de nouvelles",
                ...
                "ru" : "Только местные организации и ассоциации способны определить необходимые действия и создать общую базу информации по теме. Сайт Réfugiés.info дает каждой территории возможность выявлять и оценивать существующие инициативы, а также создавать новые."
            },
            ...
            "contributive_3_subheader" : {
                "fr" : "En donnant à chacun la possibilité d’être facilement acteur et contributeur de la plateforme, à l’instar de Wikipédia, Réfugiés.info favorise de nouvelles formes de micro-engagement permettant à de nouveaux publics de s’engager pour une cause de solidarité, en faveur des réfugiés",
                ...
                "ru" : "Предоставляя каждому возможность стать создателем и автором платформы по принципу Википедии, сайт Réfugiés.info продвигает новые принципы участия в социально-значимых проектах помощи беженцам."
            }
        },
        "CommentContribuer" : {
            "Comment contribuer" : {
            ...
            "Proposez directement" : {
                "fr" : "Proposez directement une reformulation ou un ajout au texte pour aider les responsables",
                ...
                "ru" : "Предложить редакторам свою формулировку текста или добавить недостающую информацию"
            },
            "Écoute du texte" : {
                "fr" : "Écoute du texte",
            ...
            "Écoutez ou faites écouter" : {
                "fr" : "Écoutez ou faites écouter les informations écrites de la plateforme",
            ...
            "paragraphe pas accessible" : {
                "fr" : "Ce paragraphe n'est pas accessible dans une langue que vous maîtrisez ? Aidez-nous à le traduire !",
                ...
                "ru" : "Этот раздел не доступен на языке, которым вы владеете? Помогите нам его перевести!"
            },
            "traducteurs actifs" : {
            ...
            "Ajouter dispositif cardbody" : {
                "fr" : "Rédigez la fiche pratique d'un dispositif d'accompagnement pour que les personnes réfugiées soient pleinement informées et puissent s'y engager.",
                ...
                "ru" : "Создайте страницу информации об услугах и программах поддержки от сопровождающей организации или НКО, чтобы повысить осведомленность и доступность этих услуг для получателей помощи."
            },
            "Expliquer démarche cardbody" : {
                "fr" : "Rédigez la fiche pratique d'une démarche administrative qui détaille, étape par étape, les actions à mener pour la réussir.",
                ...
                "ru" : "Создайте страницу информации о конкретной административной процедуре, с подробным и поэтапным описанием действий, которые необходимо предпринять для успешного завершения этой процедуры."
            },
            "Ajouter définition cardbody" : {
                "fr" : "Enrichissez le lexique collaboratif pour que tout le monde comprenne mieux les mots de l’intégration.",
                ...
                "ru" : "Добавьте новое слово в Словарь терминов, чтобы другим было проще разобраться в терминологии, связанной с процессом интеграции."
            },
            "Créer parcours cardbody" : {
                "fr" : "Vous avez un objectif ? On vous liste les étapes à franchir pour l’atteindre dans notre moteur de parcours d’intégration.",
        ...
        "Dispositifs" : {
            ...
            "Subheader" : {
                ...
                "ru" : "Здесь вы сможете разобраться как получить доступ к вашим социальным правам, найти работу, а также найти курсы французского языка"
            }
        },
        ...
        "Login" : {
            ...
            "Problème mdp" : {
                "fr" : "Un problème est survenu au moment de réinitialiser le mot de passe. Merci d'essayer à nouveau",
                "id" : "struct_9u1txbk37dw5go",
                "en" : "A problem occurred while resetting your password. Please try again.",
                "ar" : "حدثت مشكلة أثناء إعادة تعيين كلمة المرور. شكراً للمحاولة مرة أخرى",
                "ps" : "درمز (پاس ورډ) په کارولو کې له ستونزی سره مخ شوی. مهرباني وکړی یوځل بیا کوشش وکړئ.",
                "ti-ER" : "ኣብ ዝሓለፈ ካልኣይ ክትፍትን ከለኻ በቲ ናይ ቅድም ፓስ ዎርድ የሽግሩ ነሮም ፣ ሕጂ ግን ኽትፍትን ከለኻ ብካልእ ሓድሽ ፓስ ዎርድ ጌርካ ፈትን፣   የቐነልና ብ ምፍታንካ",
                "fa" : "اگردر تنظیم رمز عبور (پاس ورد) مشکلی روبرو شدید، لطفا دوباره کوشش کنید.",
                "ru" : "При сбросе пароля возникла проблема. Пожалуйста, попробуйте еще раз."
            },
        ...
        "Dispositif" : {
            "fiabilite_faible" : {
                "fr" : "Une information avec une faible fiabilité n'a pas été vérifiée auparavant",
        ...
        "CheckDemarche" : {
            ...
            "Ce type de fiche" : {
                "fr" : "Ce type de fiche concerne seulement les démarches proposées par l’État ou par une institution publique",
                ...
                "ru" : "Этот тип файла касается только процедур, предложенных государством или государственным учреждением"
            },
            "Exemple" : {
                "fr" : "Exemple : la demande de logement social est une démarche administrative",
                ...
                "ru" : "Пример: запрос социального жилья является административной процедурой"
            },
            "Le programme" : {
                ...
                "ru" : "Например, программа Volont'R в рамках системы национального волонтерства  - это программа"
            },
            "Finalement" : {
            ...
            "je suis sur" : {
                "fr" : "Je suis sûr de vouloir créer une fiche <b>démarche administrative</b>",
                ...
                "ru" : "Я уверен, что хочу создать карточку <b>административной процедуры</b>"
            }
        },
        "Toolbar" : {
            "Accueil" : {
        ...
        "CMU-C, demande de logement social, solidarité transport" : {
            ...
            "ru" : "Дополнительная медицинская страховка (CMU-C), запрос на социальное жилье, оплата проезда"
        },
        "Rechercher" : {
            "fr" : "Rechercher",
