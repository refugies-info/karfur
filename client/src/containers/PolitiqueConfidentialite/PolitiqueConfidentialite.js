  ...
  render() {
    return (
      <div className="animated fadeIn politique-de-confidentialite texte-small">
        ...
        <h3>Contribution</h3>
        <p>
          Si vous vous connectez à notre site web pour contribuer au contenu,
          vos données de connexion, telle que votre pseudo, votre adresse IP et
          les informations de l’agent utilisateur de votre navigateur sont
          collectés pour nous aider à la détection des connexions indésirables.
          Vous n'avez pas besoin de communiquer votre email pour créer un compte
          utilisateur. Toutefois, une fois connecté, vous pourrez renseigner
          votre e-mail dans votre profil utilisateur. En ce cas, nous conservons
          également votre e-mail. Votre mot de passe de connexion au site est
          stocké sur nos serveurs sous forme cryptée. Nous n'y avons pas accès
          en clair.
        </p>
        ...
        <p>
          ...
          modification et de suppression concernant des données qui vous
          concernent personnellement. Ce droit peut être exercé par voie
        ...
        <p>
          ...
          données sur vous, utiliser des cookies, embarquer des outils de suivis
          tiers, suivre vos interactions avec ces contenus embarqués si vous
          disposez d’un compte connecté sur leur site web.
        </p>

        <h3>Durée de stockage de vos données</h3>
        <p>
          Si vous publiez des contenus sur ce site, ces contenus et leurs
          métadonnées sont conservés indéfiniment. Pour les utilisateurs et
          utilisatrices qui s’enregistrent sur notre site, nous stockons
          également les données personnelles indiquées dans leur profil. Tous
          les utilisateurs et utilisatrices peuvent voir, modifier ou supprimer
          leurs informations personnelles à tout moment (pseudonyme, e-mail,
          mini-biographie, avatar). Les gestionnaires du site peuvent aussi voir
        ...
        <p>
          Les contributions publiées sur notre site ainsi que les informations
          contenues dans les profils des utilisateurs identifiés peuvent être
          vérifiés par nos équipes, ou à l’aide de systèmes automatisés de
          détection de contenus indésirables. A tout moment nous nous réservons
          la possibilité de supprimer ces informations et de supprimer les
          données d'un profil utilisateur.
        </p>

        <h3>Procédures mises en œuvre en cas de fuite de données</h3>
        <p>
          En cas de fuite de données personnelles vous concernant, nous nous
          engageons à vous en informer dans les meilleurs délais. Et de vous
          transmettre les procédures mises en place par nos services en cas de
