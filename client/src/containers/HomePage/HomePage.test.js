...
describe('HomePage', () => {
  ...
  it('mounts without crashing', () => {
    const mounted = mount(<MemoryRouter><I18nextProvider i18n={i18n}><HomePage t={k=>k} history={history} /></I18nextProvider></MemoryRouter>).childAt(0).childAt(0).childAt(0).childAt(0);
  ...
  it('redirects to AdvancedSearch when SearchItem clicked', () => {
    ...
    const mounted = mount(<MemoryRouter><I18nextProvider i18n={i18n}><HomePage t={k=>k} history={history} /></I18nextProvider></MemoryRouter>);
