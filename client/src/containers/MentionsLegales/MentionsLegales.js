  ...
  render() {
    return (
      <div className="animated fadeIn mentions-legales texte-small">
        ...
        <p>Ou par courrier postal, daté et signé, accompagné d'une copie d’un titre d’identité, à l'adresse suivante :</p>
        ...
        <p>Les informations personnelles collectées ne sont en aucun cas confiées à des tiers. Pour plus d'information consultez la page relative à <a href="/politique-de-confidentialite/"><strong>notre politique de confidentialité</strong></a>.</p>
        ...
        <p>Le site Refugies.info est hébergé par la société
        <a href="https://www.ovh.com">OVH</a>. 2 rue Kellermann – 59100 Roubaix – France
        Téléphone : 08 90 39 09 75 (France)</p>
      </div>
    );
  }
}
