...
class Register extends Component {
  ...
  send = (e) => {
    ...
    if (this.state.username.length === 0) {
      Swal.fire("Oops...", "Aucun nom d'utilisateur renseigné", "error");
      return;
    }
    if (
              ...
              <CardGroup>
                    ...
                    <Form onSubmit={this.send}>
                      ...
                      <div className="footer-buttons">
                        <Button
                          type="button"
                          color="transparent"
                          className="px-0 text-white password-btn"
                        >
                          <NavLink
                            to={{
                              pathname: "/login",
                          ...
                          >
                            <u>Déjà un compte ? connectez-vous</u>
                          </NavLink>
                        </Button>
                ...
                <Card className="text-dark d-md-down-none card-right">
                  <CardBody className="text-center">
                    ...
                    <p>
                      Devenez contributeur, sauvegardez vos contenus favoris,
                      rejoignez une communauté mobilisée pour aider les
                      réfugiés...
                    </p>
