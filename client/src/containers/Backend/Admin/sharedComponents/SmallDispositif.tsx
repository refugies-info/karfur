  ...
  return (
    ...
    >
      ...
      <div>
        ...
        {dispositif.creator && <div>par <strong>{dispositif.creator.username}</strong></div>}
        {dispositif.hasCreatedStructure && <div><strong>Fiche ayant créé la structure</strong></div>}
      </div>
      <div className={styles.status}>
        <StyledStatus text={dispositif.status} />
      </div>
    </div>
  );
};
