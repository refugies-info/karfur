            ...
            <div className="card">
              <div className="card-header msg_head">
                ...
                <div className={this.state.attachedClasses.join(" ")}>
                  <ul>
                    <li>
                      <i className="fa fa-user-circle"></i> Voir le profil
                    </li>
                    <li>
                      <i className="fa fa-users"></i> Ajouter aux favoris
                    </li>
                    <li>
                      <i className="fa fa-plus"></i> Ajouter à un groupe
                    </li>
                    <li>
                      <i className="fa fa-ban"></i> Bloquer
                    </li>
                  </ul>
                </div>
              </div>
