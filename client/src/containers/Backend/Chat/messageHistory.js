export default [
  ...
  { type: "text", author: "me", data: { text: "Tu me passes le sel?" } },
  {
    type: "text",
    author: "them",
    data: { text: "J'adore me regarder dans la glace" },
  },
  { type: "text", author: "me", data: { text: "Vive le PSG" } },
  { type: "text", author: "them", data: { text: "On mange où?" } },
  { type: "text", author: "me", data: { text: "C'est par où le CADA?" } },
  ...
  { type: "text", author: "me", data: { text: "Je suis sérieux" } },
  { type: "emoji", author: "me", data: { text: "😋" } },
];
