...
class UserVariantes extends Component {
  ...
  validateCriteres = () => {
    let query = {
      ...(this.state.age !== "" &&
        Number(this.state.age) && { age: this.state.age }),
  ...
  render() {
    ...
    const currAges = variantes.reduce(
      (acc, curr) => [
        ...acc,
        { bottomValue: curr.bottomValue, topValue: curr.topValue },
      ],
      []
    );
        ...
        <div className="user-variantes">
          <div className="bandeau-haut">
            ...
            <div className="contenu-bandeau">
              {t(
                "Dispositif.Personnalisation disponible",
...
export default withRouter(withTranslation()(UserVariantes));
