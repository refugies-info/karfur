...
import "./DeclarationAccessibilite.scss";

class DeclarationAccessibilite extends Component {
  componentDidMount() {
    window.scrollTo(0, 0);
  }
  ...
  render() {
    return (
      <div className="animated fadeIn declaration-accessibilite">
        ...
        <p>
          Sur cette page, vous trouverez les informations obligatoires concernant l’accessibilité de la plateforme Réfugiés.info.
        </p>
        <p>L’accessibilité permet à tous les publics, sans discrimination, d’accéder aux contenus et aux services numériques. Pour cela, il faut respecter des règles émises par le World Wide Web Consortium et pensées par des ergonomes pour chaque type de handicap.</p>
        <p>La Délégation interministérielle à l'accueil et à l'intégration des réfugiés s'engage à rendre son application mobile accessible conformément à l’article 47 de la loi n° 2005-102 du 11 février 2005 ;</p>
        <p>À cette fin, elle met en œuvre la stratégie et les actions détaillées dans son plan pluriannuel en cours d'élaboration. Cette déclaration d’accessibilité s’applique au site web Réfugiés.info</p>

        <h2 className="h4">État de conformité : non conforme</h2>
        <p>Le site Réfugiés.info est non conforme avec le RGAA 4.1 de niveau Double-A (AA) en raison des non-conformités et des dérogations énumérées ci-dessous.</p>
        <h3 className="h4">Résultats des tests</h3>
        ...
        <div className="box">
          <p className="box-title">Résultat de conformité des critères au RGAA 4.1</p>
          <img src={ConformiteResults} />
          <div className="box-legend">
            <p>
              <span className="box-color box-color--valid"></span>critères conformes</p>
            <p>
            <span className="box-color box-color--invalid"></span>critères non conformes
            </p>
          </div>
        </div>

        <h3 className="h4">Contenus non accessibles</h3>
        <p>Les contenus listés ci-dessous ne sont pas accessibles pour les raisons suivantes.</p>
        <h4 className="h5">Non-conformité</h4>
        <ul>
          <li>Plusieurs éléments de non-conformité sont décrits dans ce document, dont certains récurrents sur plusieurs pages :</li>
          ...
          <li>Le contraste entre la couleur de fond et les textes de certains composants d’interface n'est pas suffisant</li>
        ...
        <h4 className="h5">Dérogations pour charge disproportionnée</h4>
        <p>Pas de dérogation identifiée</p>

        <h4 className="h5">Contenus non soumis à l’obligation d’accessibilité</h4>
        <p>Pas de contenus non soumis à l'obligation d'accessibilité</p>

        <h2 className="h4">Établissement de cette déclaration d’accessibilité</h2>
        ...
        <h2 className="h4">Retour d’information et contact</h2>
        ...
        <h2 className="h4">Voies de recours</h2>
        ...
        <ul>
          <li>Écrire un message au <a href="https://formulaire.defenseurdesdroits.fr/code/afficher.php?ETAPE=accueil_2016" target="_blank" rel="noreferrer noopener">Défenseur des droits</a></li>
          <li>Contacter le délégué du <a href="https://www.defenseurdesdroits.fr/saisir/delegues"  target="_blank" rel="noreferrer noopener">Défenseur des droits de ta région</a></li>
