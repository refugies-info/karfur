          ...
          <div className="section-container">
            ...
            <Row className="card-row">
              <Col lg="4" className="card-col">
                <Card>
                  <CardHeader>{t("QuiSommesNous.problem_1_header", "Comprendre le statut de réfugié")}</CardHeader>
                  <CardBody>
                    <span>{t("QuiSommesNous.problem_1_subheader", "Mieux comprendre c'est déjà mieux accueillir. Migrant, demandeur d'asile ou réfugié ne désignent pas les mêmes réalités. Réfugiés.info s'adresse aux réfugiés statutaires, c'est-à-dire aux personnes à qui la France accorde une protection internationale car leur vie est menacée dans leur pays d'origine")}.</span>
                  </CardBody>
                  {/* <CardFooter>
                    <FButton type="outline-black">
                      En savoir plus
              ...
              <Col lg="4" className="card-col">
                <Card>
                  ...
                  <CardBody>
                    <span>{t("QuiSommesNous.problem_2_subheader", "L’évolution rapide de la législation, le foisonnement de l’offre associative et la complexité de certaines démarches administratives rendent difficile la compréhension des droits et devoirs. Réfugiés.info centralise une information fiable, à jour et vulgarisée")}.</span>
                  </CardBody>
                </Card>
              </Col>
              <Col lg="4" className="card-col">
                <Card>
                  <CardHeader>{t("QuiSommesNous.problem_3_header", "Des ruptures d'accompagnement")}</CardHeader>
                  <CardBody>
                    <span>{t("QuiSommesNous.problem_3_subheader", "Déménagement, changement de projet de vie... À chaque nouvel interlocuteur, il faut souvent tout reprendre à zéro. Réfugiés.info propose aux réfugiés de se créer un parcours dans un espace personnel qu'il peuvent partager avec leurs aidants")}.</span>
                  </CardBody>
                </Card>
              </Col>
            </Row>
        ...
        <section id="approche">
          <div className="section-container">
            ...
            <Row className="card-row">
              <Col lg="4" className="card-col">
                <Card>
                  <CardHeader>{t("QuiSommesNous.contributive_1_header", "Un projet entièrement ouvert")}</CardHeader>
                  <CardBody>
              ...
              <Col lg="4" className="card-col">
                <Card>
                  ...
                  <CardBody>
                    <span>{t("QuiSommesNous.contributive_3_subheader", "En donnant à chacun la possibilité d’être facilement acteur et contributeur de la plateforme, à l’instar de Wikipédia, Réfugiés.info favorise de nouvelles formes de micro-engagement permettant à de nouveaux publics de s’engager pour une cause de solidarité, en faveur des réfugiés")}.</span>
                  </CardBody>
                  <CardFooter>
