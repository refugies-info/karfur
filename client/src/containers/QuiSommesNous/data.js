...
export const partners = [
  ...
  { name: "IFRI", date: new Date("10/17/2019"), logo: IFRI },
  ...
  { name: "Habitat Humanisme", date: new Date("10/31/2019"), logo: Habitat },
  { name: "JRS France", date: new Date("10/31/2019"), logo: JRS },
  { name: "CESAM", date: new Date("11/04/2019"), logo: CESAM },
