...
import { Globals, animated, Controller, config } from 'react-spring/renderprops';
...
class ParallaxLayer extends React.PureComponent {
  ...
  setPosition(height, scrollTop, immediate) {
    ...
    const config$$1 = this.parent.props.config;
...
class Parallax extends React.PureComponent {
  ...
  constructor(props) {
    ...
    this.scrollerRaf = () => Globals.requestFrame(this.moveItems);
    ...
    this.updateRaf = () => {
      Globals.requestFrame(this.update); // Some browsers don't fire on maximize
