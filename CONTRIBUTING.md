# Contributing to Karfu'R

Looking to contribute something to Karfu'R? **Here's how you can help.**
...
1. [Fork](https://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/karfur.git
