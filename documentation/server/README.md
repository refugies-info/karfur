...
The minimal version of the application (\_MINIMUM_APP_VERSION variable) must be configured in the build pipeline of the server. You must specify the version under the YYYY.MM.V format (Y: year; M: month; V: version in month).
