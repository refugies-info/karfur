...
interface HeaderInnerDefaultProps {
...
const HeaderInnerDefault = ({
  animatedController,
  showSimplifiedHeader,
  title,
  titleIcon,
}: HeaderInnerDefaultProps) => {
  const theme = useTheme();
...
interface HeaderInnerContentProps extends HeaderInnerDefaultProps {
  headerBackgroundColor?: string;
