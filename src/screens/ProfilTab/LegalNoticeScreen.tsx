  ...
  return (
    <Page title={t("profile_screens.legal_notice")}>
      ...
      <P>
        ...
        l’application dans l’intitulé du lien est vivement souhaitée.
      </P>
      <P>
      ...
      <P>
        ...
        pornographique, xénophobe ou étant de nature à heurter la sensibilité du
        public.
      </P>
      ...
      <P>
        Il est possible que certaines situations (panne, intention technique de
        maintenance) empêchent l’accès à l’application. Réfugiés.info a le droit
        de ne pas garantir l’accessibilité sans que sa responsabilité ne soit
        engagée.
      </P>
