    ...
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        <P>
          ...
          respecter des règles émises par le World Wide Web Consortium et
          pensées par des ergonomes pour chaque type de handicap.
        </P>

        <ReadingTime isRTL={isRTL} text="5 à 10 minutes" />
        ...
        <P>
          ...
          applications Web et mobiles (Directive (UE) 2018/2048) sur les
          exigences d'accessibilité pour les produits et services TIC EN 301 549
          V3.2.1.
        </P>
        <P>
          À cette fin, il met en œuvre la stratégie et les actions détaillées
          dans son plan pluriannuel en cours d'élaboration.
        </P>
        ...
        <P style={{ marginBottom: 0 }}>
          ...
          avec EN 301 549 V3.2.1 en raison des non-conformités et des
        ...
        <P>
          ...
          révèle que {isIOS ? "50,00" : "45,83"}% des critères de la Directive
          EN 301 549 V3.2.1 sont respectés.
        </P>
        <RTLView
        ...
        <P style={{ marginBottom: 0 }}>
          ...
          d'agents utilisateurs et de lecteurs d’écran suivants :
        </P>
        <List
          isRTL={isRTL}
