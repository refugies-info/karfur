...
export const PrivacyPolicyScreen = ({
  ...
  return (
    <Page title={t("profile_screens.privacy_policy")}>
      <P>
      ...
      <ContentCard step={"1"} title={"C’est quoi et à quoi ça sert ?"}>
        <P>
      ...
      <ContentCard step={"2"} title={"Comment ça marche ?"}>
        <P>
      ...
      <ContentCard step={"3"} title={"Qui peut avoir accès à ces données ?"}>
        ...
        <P>
          Ces informations et ta sélection de fiches de l’onglet “Mes fiches”
          sont stockées directement sur ton téléphone.
        </P>
      ...
      <ContentCard
        step={"4"}
        title={
          "Comment faire si tu n’es pas d’accord avec l’utilisation de tes données ?"
        }
      >
      ...
      <ContentCard step={"1"} title={"C’est quoi et à quoi ça sert ?"}>
        <P>
          ...
          automatiquement des informations sur ta navigation, par exemple
          combien de temps tu passes sur une de nos fiches.
        </P>
        <Image
          source={YourData}
          style={{
        ...
        />
        <P style={{ marginBottom: 0 }}>
          Grâce à ces informations, nous faisons des statistiques pour nous
          aider à améliorer l’application au fil du temps et à mieux comprendre
          tes besoins.
        </P>
      </ContentCard>
      <ContentCard step={"2"} title={"Comment ça marche ?"}>
        <P>
          Quand tu navigues dans l’application, nos sociétés partenaires
          Firebase et Google Analytics récoltent automatiquement des données qui
          tracent ton activité sur notre application. Ce sont des traceurs.
        </P>
        <P style={{ marginBottom: 0 }}>
          Nous récupérons ces informations de manière anonyme et compilées.
          Elles nous permettent de mieux comprendre comment toi et les autres
          utilisateurs naviguez sur notre application. Elles nous permettent
          aussi de réaliser des statistiques afin d’améliorer l’application.
        </P>
      </ContentCard>
      <ContentCard step={"3"} title={"Qui peut avoir accès à ces données ?"}>
        <P>
        ...
        <P>
          Pour comprendre comment et combien de temps ces sociétés conservent
          tes données de navigation, tu peux aller consulter leurs propres
      ...
      >
        <P>
          ...
          désinstallant l’application ou les gérer directement via les
          paramètres Android ou iOS de ton téléphone.
        </P>
        <P style={{ marginBottom: 0 }}>
          Si tu souhaites réinitialiser l’identifiant anonyme attribué
          automatiquement par Firebase, tu peux cliquer sur le bouton
          “Réinitialiser l’application” dans l’onglet “Moi” en bas à droite de
          ton écran.
        </P>
      </ContentCard>
      <H1>Qui sommes-nous ?</H1>
      <P style={{ marginBottom: 0 }}>
        Nous sommes Réfugiés.info, une plateforme numérique qui propose de
        l’information simple et traduite sur 12 thématiques de l’intégration.
        Visite la page{" "}
        <Link
          accessibilityRole="link"
          onPress={() => {
