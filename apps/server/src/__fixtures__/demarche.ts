...
demarche.translations = {
  fr: {
    content: {
      ...
      titreMarque: "",
      abstract:
        "Découvrez les cas où vous allez recevoir un livret de famille de l'Ofpra ou de votre mairie",
      ...
      how: {
        "1ee3b60e-b3b8-408a-8e51-00d43467f4a4": {
          title:
            "Avoir un livret de l'Ofpra : vous êtes marié et l’Ofpra a fait votre certificat de mariage ",
        ...
        "c5009aa7-6e17-47fc-a7e3-a2e4254a6ad5": {
          title:
            "Avoir un livret d’une mairie : vous n'êtes pas marié et votre enfant est né en France ",
      ...
      next: {
        "f5fef43c-c548-443c-952b-588ac144a6b1": {
          title:
            "Si vous perdez votre livret de famille ou si vous avez besoin d'un second livret de famille",
  ...
  fa: {
    content: {
      ...
      how: {
        "1ee3b60e-b3b8-408a-8e51-00d43467f4a4": {
          title:
            "داشتن دفترچهٔ خانوادهٔ Ofpra: شما ازدواج کرده‌اید و Ofpra گواهی ازدواج شما را صادر کرده است",
        ...
        "21887132-46cf-457c-8ed6-3bfe691da7c7": {
          title:
            "داشتن دفترچهٔ خانوادهٔ Ofpra: فرزندان شما  فرزندان شما پس از محافظت شما به فرانسه آمده اند",
        ...
        "c5009aa7-6e17-47fc-a7e3-a2e4254a6ad5": {
          title:
            "داشتن دفترچهٔ خانوادهٔ شهرداری: شما ازدواج نکرده اید و فرزند شما در فرانسه به دنیا آمده است",
      ...
      next: {
        "f5fef43c-c548-443c-952b-588ac144a6b1": {
          title:
            "اگر دفترچه ثبت خانواده خود را گم کردید یا اگر به دفترچه ثبت خانواده دوم نیاز دارید",
...
demarche.metadatas = {
  ...
  age: null,
  price: null,
  publicStatus: ["refugie", "subsidiaire", "apatride", "french"],
  public: ["family"],
  conditions: null,
  timeSlots: [],
};
