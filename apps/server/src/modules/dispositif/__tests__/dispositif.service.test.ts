...
describe.skip("publish dispositif", () => {
  ...
  it("should update languages avancement and add content in airtable", async () => {
    ...
    updateDispositifInDBMock.mockResolvedValueOnce(demarcheFixture);
  ...
  it("updateLanguagesAvancement throws", async () => {
    ...
    updateDispositifInDBMock.mockResolvedValueOnce(dispositifFixture);
    ...
    expect(sendMailWhenDispositifPublished).toHaveBeenCalledWith(dispositifFixture);
  });
