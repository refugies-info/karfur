...
export const LegalNoticeScreen = () => {
  ...
  return (
    ...
    >
      ...
      <P>
        Sur cette page, tu trouveras toutes les informations obligatoires sur l’application
        Réfugiés.info. Par exemple : Qui est notre hébergeur ? Qui détient les droits d’auteur sur
        les contenus que nous publions ?
      </P>
      ...
      <P>
        L’application Réfugiés.info a été créée par la Délégation interministérielle à l'accueil et
        à l'intégration des réfugiés du Ministère de l’Intérieur.
      </P>
      ...
      <H2>Les contenus</H2>
      <P>
        Les informations que l’on trouve sur l’application Réfugiés.info sont publiques et peuvent
        être reproduites ou réutilisées librement, à condition de :
      </P>
      <List
        isRTL={isRTL}
        items={[
      ...
      <Callout>
        ...
        <P style={{ marginBottom: 0 }}>
          Tu ne peux pas non plus utiliser le contenu de l’application en le détournant de son
          contexte d’actualité, ou de manière contraire aux lois et aux règlements, ou d’une façon
      ...
      <P>
        Toute reproduction ou adaptation (retouchage, montage, recadrage...) des éléments graphiques
        et iconographiques du site est interdite sans l’accord de Réfugiés.info.
      </P>
      ...
      <P>
        Tu peux librement créer des liens vers Réfugiés.info sans accord préalable. En revanche, la
        mention explicite de l’intitulé de l’application dans l’intitulé du lien est vivement
        souhaitée.
      </P>
      <P>
        Il est fortement recommandé que l’ouverture de cette page se fasse dans une fenêtre
        indépendante du navigateur.
      </P>
      <P style={{ marginBottom: 0 }}>
        Toutefois, Réfugiés.info se réserve le droit de demander la suppression de liens vers des
        sites dont l’objet s’avérerait non conforme à l’objet de l’application, diffuseraient des
        informations à caractère raciste, pornographique, xénophobe ou étant de nature à heurter la
      ...
      <P style={{ marginBottom: 0 }}>
        Des liens vers d’autres sites, publics ou privés sont proposés sur l’application pour te
        faciliter l’accès à l’information. Réfugiés.info n’est pas responsable du contenu de ces
        sites.
      </P>
      ...
      <P>
        Réfugiés.info et son hébergeur font le maximum pour te permettre d’avoir accès en continu à
        l’application Réfugiés.info.
      </P>
      <P>
        Il est possible que certaines situations (panne, intention technique de maintenance)
        empêchent l’accès à l’application. Réfugiés.info a le droit de ne pas garantir
        l’accessibilité sans que sa responsabilité ne soit engagée.
      </P>
      ...
      <P>
        Si tu ne trouves pas l’information que tu cherches, n’hésite pas à consulter les autres
