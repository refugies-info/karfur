          ...
          >
            <Columns layout="auto" horizontalAlign="center">
              <Button
                ...
                color={hasThanked ? theme.colors.white : theme.colors.dsfr_action}
                iconColor={hasThanked ? theme.colors.white : theme.colors.dsfr_action}
                backgroundColor={hasThanked ? theme.colors.dsfr_action : undefined}
                iconName="thumb_up"
