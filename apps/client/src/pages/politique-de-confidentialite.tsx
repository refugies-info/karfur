    ...
    <div className="w-full">
      <div className={"animated fadeIn texte-small"}>
        ...
        <p>
          ...
          pseudo, votre adresse IP et les informations de l’agent utilisateur de votre navigateur sont collectés pour
          nous aider à la détection des connexions indésirables. Vous n&apos;avez pas besoin de communiquer votre email
          pour créer un compte utilisateur. Toutefois, une fois connecté, vous pourrez renseigner votre e-mail dans
          votre profil utilisateur. En ce cas, nous conservons également votre e-mail. Votre mot de passe de connexion
          au site est stocké sur nos serveurs sous forme cryptée. Nous n&apos;y avons pas accès en clair.
        </p>

        <h3>Médias</h3>
        <p>
          Si vous êtes un utilisateur ou une utilisatrice enregistré·e et que vous téléversez des images sur le site
        ...
        <p>
          ...
          autre site.Ces sites web pourraient collecter des données sur vous, utiliser des cookies, embarquer des outils
          de suivis tiers, suivre vos interactions avec ces contenus embarqués si vous disposez d’un compte connecté sur
          leur site web.
        </p>
        ...
        <p>
          ...
          nous avez fournies. Vous pouvez également demander la suppression des données personnelles vous concernant.
        ...
        <p>
          Les contributions publiées sur notre site ainsi que les informations contenues dans les profils des
          utilisateurs identifiés peuvent être vérifiés par nos équipes, ou à l’aide de systèmes automatisés de
          détection de contenus indésirables. A tout moment nous nous réservons la possibilité de supprimer ces
          informations et de supprimer les données d&apos;un profil utilisateur.
        </p>
        ...
        <p>
          ...
          institutionnels, nous pouvons être amenés à recevoir des données personnelles vous concernant. Telles que
          votre nom, votre e-mail ou votre fonction. Nous nous engageons à n&apos;utiliser ces données que dans le cadre
          limité à l&apos;opération menée en commun avec ces partenaires.
        </p>
      </div>
    </div>
  );
