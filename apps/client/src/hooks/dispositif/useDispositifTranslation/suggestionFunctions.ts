 ...
 */
export const transformMyTranslation = (
  section: string,
  traductions: DeepPartialSkipArrayKey<TranslateForm>,
 ...
 */
export const filterAndTransformTranslations = (
  section: string,
  traductions: GetTraductionsForReview[] | null,
): Suggestion[] =>
  !traductions
    ? []
    : traductions
