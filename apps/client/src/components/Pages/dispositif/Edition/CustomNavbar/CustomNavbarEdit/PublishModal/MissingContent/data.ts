...
export const help = {
  draft:
    "Il reste quelques informations pour envoyer votre fiche pour relecture à l’équipe éditoriale de Réfugiés.info.",
  waiting:
    "Votre fiche va repasser en brouillon. Vous devrez la compléter et la valider pour qu’elle soit à nouveau envoyée à notre équipe éditoriale pour relecture.",
  published:
    "Il reste quelques informations à remplir. Vous pourrez les compléter plus tard. En attendant, l’ancienne version de votre fiche est toujours visible.",
};
