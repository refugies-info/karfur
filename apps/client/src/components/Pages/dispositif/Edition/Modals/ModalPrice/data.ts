import type { priceDetails } from "@refugies-info/api-types";

export const help = {
  title: "Comment choisir ?",
  content:
    "Cochez payant si vous avez des frais spécifiques (d'inscription, de dossier, loyers, abonnement, etc.). Vous pouvez cocher gratuit seulement si aucun frais n’est demandé.",
};
