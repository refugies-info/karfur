...
export const help = [
  ...
  },
  {
    title: "Quelques conseils",
    content:
      "Si cette information varie selon les personnes, cochez la case « Cette information n’est pas pertinente pour mon action » et expliquez les détails dans votre fiche.",
  },
  {
    title: "Quelques conseils",
    content: [
...
export const timeSlotOptions: timeSlotType[] = [
  "monday",
  "tuesday",
  "wednesday",
  "thursday",
