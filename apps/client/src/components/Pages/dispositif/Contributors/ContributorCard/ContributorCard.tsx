...
const ContributorCard = ({ user }: Props) => {
  ...
  return (
    <div className="border-dsfr-border-default-grey bg-action-low-blue-france flex h-auto w-[11.6625rem] flex-col items-center gap-2 border-none p-3 shadow-sm">
      <Image
