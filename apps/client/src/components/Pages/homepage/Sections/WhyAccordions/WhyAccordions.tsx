...
const WhyAccordions = (props: Props) => {
  ...
  const accordionItemsDesktop = [
    {
      title: t(
        "Homepage.accordionItems.desktop.title1",
        "Pour avoir des explications sur toutes les démarches administratives",
      ),
      text: t("Homepage.accordionItems.desktop.text1", {
      ...
      alt: t(
        "Homepage.accordionItems.desktop.alt1",
    ...
    {
      title: t("Homepage.accordionItems.desktop.title2", "Découvrez les actions de votre territoire"),
      text: t("Homepage.accordionItems.desktop.text2", {
        count: props.nbDemarches,
        defaultValue:
      ...
      alt: t(
        "Homepage.accordionItems.desktop.alt2",
    ...
    {
      title: t("Homepage.accordionItems.desktop.title3", "Partagez facilement l’information à vos bénéficiaires"),
      text: t("Homepage.accordionItems.desktop.text3", {
        count: props.nbDemarches,
        defaultValue:
      ...
      alt: t(
        "Homepage.accordionItems.desktop.alt3",
    ...
    {
      title: t("Homepage.accordionItems.desktop.title4", "Bénéficiez d'un outil de médiation"),
      text: t("Homepage.accordionItems.desktop.text4", {
        count: props.nbDemarches,
        defaultValue:
  ...
  const accordionItemsMobile = [
    {
      title: t(
        "Homepage.accordionItems.mobile.title1",
        "Pour avoir des explications sur toutes les démarches administratives",
      ),
      text: t("Homepage.accordionItems.mobile.text1", {
        count: props.nbDemarches,
        defaultValue:
      ...
      alt: t(
        "Homepage.accordionItems.mobile.alt1",
    ...
    {
      title: t(
        "Homepage.accordionItems.mobile.title2",
